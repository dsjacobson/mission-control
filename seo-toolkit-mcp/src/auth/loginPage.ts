...
<head>
  <meta charset="utf-8" />
  <title>Connect to SEO Toolkit</title>
...
<body>
  <div class="card">
    <h1>Connect to SEO Toolkit</h1>
    <p><strong>${escapeHtml(params.clientName)}</strong> wants to access your SEO Toolkit workspace.</p>
