...
export const config = {
  ...
  // Public HTTPS URL this server is reachable at (e.g. https://seo-toolkit-mcp-xxxx.onrender.com).
  ...
  // The password entered on the /login consent screen when Claude first connects.
  ...
  // SEO Toolkit's own API, already secured by its X-API-Key middleware.
  seoToolkit: {
    baseUrl: required('SEO_TOOLKIT_API_BASE_URL'),
    apiKey: required('SEO_TOOLKIT_API_KEY')
  },
