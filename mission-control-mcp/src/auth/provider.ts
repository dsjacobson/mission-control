...
class MissionControlClientsStore implements OAuthRegisteredClientsStore {
...
export class MissionControlOAuthProvider implements OAuthServerProvider {
  readonly clientsStore = new MissionControlClientsStore();
